...
<header id="masthead" class="site-header <?php echo ( get_theme_mod( 'mystore-header-layout' ) == 'mystore-header-layout-standard' ) ? sanitize_html_class( 'mystore-header-layout-standard' ) : sanitize_html_class( 'mystore-header-layout-centered' ); ?> <?php echo ( get_theme_mod( 'mystore-header-search' ) ) ? sanitize_html_class( 'header-search-on' ) : 'header-search-off'; ?> <?php echo ( get_theme_mod( 'mystore-header-remove-topbar' ) ) ? 'header-no-topbar' : 'header-has-topbar'; ?>">
